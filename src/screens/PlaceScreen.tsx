...
export default function PlaceScreen(props: any) {
  ...
  return (
    <View className="bg-white h-screen">
      ...
      <Image source={item.picture} className="w-full rounded-b-[60px] h-72 absolute" />
      ...
      {/* Buttons */}
      <View className="p-4 flex-row justify-between items-center absolute bottom-0 bg-white w-full">
        <TouchableOpacity>
          <Text className="font-poppins py-2 rounded-lg px-10 bg-primary-50 text-secondary-700">
            Live tour
          </Text>
        </TouchableOpacity>
        <TouchableOpacity>
